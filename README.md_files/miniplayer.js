...
fill:"#fff","fill-rule":"nonzero"}}]}]}]};var e="Abrir p\u00e1gina del v\u00eddeo";g.R(a.N().experiments,"kevlar_miniplayer_expand_top")&&(c="ytp-miniplayer-button-top-left",d=g.Y?{D:"div",X:["ytp-icon","ytp-icon-expand-miniplayer"]}:{D:"svg",M:{height:"24px",version:"1.1",viewBox:"0 0 24 24",width:"24px"},K:[{D:"g",M:{fill:"none","fill-rule":"evenodd",stroke:"none","stroke-width":"1"},K:[{D:"g",M:{transform:"translate(12.000000, 12.000000) scale(-1, 1) translate(-12.000000, -12.000000) "},K:[{D:"path",
M:{d:"M19,19 L5,19 L5,5 L12,5 L12,3 L5,3 C3.89,3 3,3.9 3,5 L3,19 C3,20.1 3.89,21 5,21 L19,21 C20.1,21 21,20.1 21,19 L21,12 L19,12 L19,19 Z M14,3 L14,5 L17.59,5 L7.76,14.83 L9.17,16.24 L19,6.41 L19,10 L21,10 L21,3 L14,3 Z",fill:"#fff","fill-rule":"nonzero"}}]}]}]},e="Expandir");g.V.call(this,{D:"button",X:["ytp-miniplayer-expand-watch-page-button","ytp-button",c],M:{title:"{{title}}","data-tooltip-target-id":"ytp-miniplayer-expand-watch-page-button"},K:[d]});this.u=a;this.ia("click",this.w,this);this.ha("title",
g.VM(a,e,"i"));g.le(this,g.fN(b.Ya(),this.element))},P5=function(a){g.V.call(this,{D:"div",
I:"ytp-miniplayer-ui"});this.player=a;this.H=!1;this.G=this.w=this.u=void 0;this.L(a,"minimized",this.bI);this.L(a,"onStateChange",this.OO)},Q5=function(a){g.NP.call(this,a);
...
g.h.show=function(){this.u=new g.vn(this.aI,null,this);this.u.start();if(!this.H){this.C=new g.hR(this.player,this);g.H(this,this.C);g.ML(this.player,this.C.element,4);this.C.B=.6;this.S=new g.gQ(this.player);g.H(this,this.S);this.A=new g.V({D:"div",I:"ytp-miniplayer-scrim"});g.H(this,this.A);this.A.ba(this.element);this.L(this.A.element,"click",this.VA);var a=new g.V({D:"button",X:["ytp-miniplayer-close-button","ytp-button"],M:{"aria-label":"Cerrar"},K:[g.oM()]});g.H(this,a);a.ba(this.A.element);
...
"ytp-button"],M:{"aria-label":"Cerrar"},K:[g.oM()]});g.H(this,a);a.ba(this.F.element);this.L(a.element,"click",this.vz);a=new g.V({D:"button",X:["ytp-miniplayer-replay-button","ytp-button"],M:{"aria-label":"Cerrar"},K:[g.CM()]});g.H(this,a);a.ba(this.F.element);this.L(a.element,"click",this.EM);this.L(this.player,"presentingplayerstatechange",this.cI);this.L(this.player,"appresize",this.Qs);this.L(this.player,"fullscreentoggled",this.Qs);this.Qs();this.H=!0}0!=this.player.getPlayerState()&&g.V.prototype.show.call(this);
...
g.h.VA=function(a){if(a.target==this.A.element||a.target==this.B.element)g.R(this.player.N().experiments,"kevlar_miniplayer_play_pause_on_scrim")?g.xD(g.uL(this.player))?this.player.pauseVideo():this.player.playVideo():this.player.ka("onExpandMiniplayer")};
g.h.bI=function(){g.L(g.sL(this.player),"ytp-player-minimized",this.player.app.H.o)};
g.h.aI=function(){g.vN(this.w);this.G.w();this.u&&this.u.start()};
g.h.cI=function(a){g.W(a.state,32)&&this.C.hide()};
g.h.Qs=function(){var a=this.w,b=g.rL(this.player).getPlayerSize().width;a.Ea=0;a.C=b;a.B=!1;g.xN(a);this.w.Iu()};
